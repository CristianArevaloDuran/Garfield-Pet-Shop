<?php
    ...
    if(!isset($_SESSION["userid"])) {
        ...
        require("../../../../db/dbConnection.php");
        $rol = $_GET["id"];
        $query = $conexion->prepare("SELECT * FROM tblRol WHERE idRol = '$rol'");
...
<body>
            ...
            <form id="addRole">
                ...
                <div class="inputs">
                    <div class="input">
                        ...
                        <input type="name" name="name" id="name" value='<?= $result['nombreRol'] ?>'>
                        <input type="id" name="id" id="id" value='<?= $result['idRol'] ?>' hidden>
                    </div>
                    <div class="input">
    ...
    <script src='./modifyQuery.js'></script>
</body>
</html>