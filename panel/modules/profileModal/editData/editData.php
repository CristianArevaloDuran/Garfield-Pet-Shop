<?php
    ...
    $query = $conexion->prepare("SELECT * FROM tblEmpleados as emp INNER JOIN tblRol as rol ON emp.rolEmpleado = rol.idRol INNER JOIN tblEstado as est ON emp.estEmpleado = est.idEstado INNER JOIN tblImgEmpleados as img ON emp.imgEmpleado = img.idImagen WHERE idEmpleado = '$_SESSION[userid]'");
